...
function matchRecordFromItem(item = {}, now = new Date()) {
  ...
  return {
    ...
    coordinationClientSummary: item.coordinationClientSummary || item.metadata?.coordinationClientSummary,
    coordinationOwnerSummary: item.coordinationOwnerSummary || item.metadata?.coordinationOwnerSummary,
    negotiationStatus: item.negotiationStatus || item.metadata?.negotiationStatus,
    lastNegotiationActivityAt: item.lastNegotiationActivityAt || item.metadata?.lastNegotiationActivityAt,
    lastNegotiationEvent: item.lastNegotiationEvent || item.metadata?.lastNegotiationEvent,
...
export function buildMatchGroupDailyTask(group, now = new Date()) {
  ...
  return buildDailyTaskView({
    ...
    coordinationClientSummary: text(active.coordinationClientSummary),
    coordinationOwnerSummary: text(active.coordinationOwnerSummary),
    negotiationStatus: text(active.negotiationStatus),
    lastNegotiationActivityAt: text(active.lastNegotiationActivityAt),
    lastNegotiationEvent: text(active.lastNegotiationEvent),
