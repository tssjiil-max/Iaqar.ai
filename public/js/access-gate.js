    ...
    try {
      ...
      if (snap.exists) {
        ...
        gate.querySelector("#publicOfficeProfile").innerHTML = `
          ${data.coverUrl || data.displayImageUrl ? `<img src="${escapeHtml(data.coverUrl || data.displayImageUrl)}" alt="صورة المكتب" style="width:100%;height:180px;object-fit:cover;border-radius:16px;margin-bottom:10px">` : ""}
          ${data.logoUrl ? `<img src="${escapeHtml(data.logoUrl)}" alt="شعار المكتب" style="width:72px;height:72px;object-fit:contain;border-radius:14px;margin-bottom:8px">` : ""}
