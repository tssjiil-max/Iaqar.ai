(() => {
  ...
  function init() {
    ...
    if ((!elements.openBtn && !elements.openCoverBtn) || !elements.overlay) return;

    if (elements.openBtn) elements.openBtn.addEventListener("click", openSettings);
    if (elements.openCoverBtn) elements.openCoverBtn.addEventListener("click", openSettings);
