 ...
 * MIT License. Adapted from the qrcode-terminal vendored implementation.
 */
(function (global) {
  "use strict";
...
module.exports = QRCode;
  ...
  const levels = require("./QRErrorCorrectLevel");
  global.qrcode = function qrcode(typeNumber, errorCorrectLevel) {
    const level = levels[String(errorCorrectLevel || "M").toUpperCase()] ?? levels.M;
    return new QRCode(Number(typeNumber) || 0, level);
  };
})(window);
